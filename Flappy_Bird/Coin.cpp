...
Coin::Coin(float pos_x, float pos_y, float width, float height,float coin_speed, const std::string& texture) :
    GameObject("Coin"), Box(pos_x, pos_y, width, height), m_coin_speed(coin_speed), m_texture(texture) {
}
...
Coin::Coin(Coin&& other) noexcept :
    ...
    m_coin_speed(std::move(other.m_coin_speed)),
