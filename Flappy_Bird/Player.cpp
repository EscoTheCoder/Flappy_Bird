...
void Player::dead_player_change_photo() {
    if (m_brush_player.texture == m_state->getFullAssetPath("redbird-downflap.png") || m_brush_player.texture == m_state->getFullAssetPath("redbird-upflap.png")) {
