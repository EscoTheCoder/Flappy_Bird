...
void Player_Level_2::init() {
    ...
    m_brush_player.texture = m_state->getFullAssetPath("blue_bird.png");
...
void Player_Level_2::movePlayer_2(float dt) {
    ...
    if (m_velocity_y < 0) {
        m_brush_player.texture = m_state->getFullAssetPath("blue_bird_down.png");
    }
    else {
        m_brush_player.texture = m_state->getFullAssetPath("blue_bird.png");
    }
...
void Player_Level_2::dead_player_change_photo() {
    if (m_brush_player.texture == m_state->getFullAssetPath("blue_bird.png")) {
        m_brush_player.texture = m_state->getFullAssetPath("blue_bird_dead.png");
    }
    else {
        m_brush_player.texture = m_state->getFullAssetPath("blue_bird.png");
    }
